...
#define R128_FL_BLUR_LONG 4096
  ...
  ufloat8 (*find_bits)(struct r128_ctx *ctx, struct r128_image *im, struct r128_line *li, ufloat8 ppos, 
                            ufloat8 uwidth, u_int32_t normalization_coeff, ufloat8 *curpos);
...
int r128_scan_line(struct r128_ctx *ctx, struct r128_image *im, struct r128_line *li, u_int32_t norm_coeff, ufloat8 offset, ufloat8 threshold);
